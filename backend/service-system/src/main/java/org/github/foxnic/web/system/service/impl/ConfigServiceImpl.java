...
public class ConfigServiceImpl extends SuperService<Config> implements IConfigService {
	 ...
	 * */
	@Override
	public boolean insertList(List<Config> configList) {
	 ...
	 * */
	@Override
	public boolean update(Config config , SaveMode mode) {
		return super.update(config , mode);
	}
	 ...
	 * */
	@Override
	public boolean updateList(List<Config> configList , SaveMode mode) {
	 ...
	 * @return 判断结果
	 */
	public Result<Config> checkExists(Config role) {
		//TDOD 此处添加判断段的代码
