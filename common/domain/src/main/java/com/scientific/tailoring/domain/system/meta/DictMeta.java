...
/**
 * @author 李方捷
 * @since 2021-05-17 01:08:23
 * @sign 1E6D2CC3A7D8EB803118ABF9EB00F0E8
...
public class DictMeta {
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION };
	
	/**
	 * 代理类
	*/
	public static class $$proxy$$ extends com.scientific.tailoring.domain.system.Dict {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Dict setCreateBy(Long createBy) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Dict setUpdateBy(Long updateBy) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Dict setDeleted(Boolean deleted) {
		 ...
		 * @return 当前对象
		*/
		public Dict setDeleteBy(Long deleteBy) {
