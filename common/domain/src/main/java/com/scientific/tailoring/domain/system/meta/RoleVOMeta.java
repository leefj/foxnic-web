 ...
 * @sign C30DCB5358C88166F7077EF8A2285DA1
...
public class RoleVOMeta extends RoleMeta {
	...
	*/
	 ...
	 * 代理类
	*/
	public static class $$proxy$$ extends com.scientific.tailoring.domain.system.RoleVO {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public RoleVO setIds(List<Integer> ids) {
