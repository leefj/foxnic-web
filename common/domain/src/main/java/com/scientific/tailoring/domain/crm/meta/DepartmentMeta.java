 ...
 * @sign B5E65343430A3D261B05CCC50989B68F
...
public class DepartmentMeta {
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , NAME , COMPANY_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , PARENT_ID };
	
	/**
	 * 代理类
	*/
	public static class $$proxy$$ extends com.scientific.tailoring.domain.crm.Department {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Department setCreateBy(Long createBy) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Department setUpdateBy(Long updateBy) {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public Department setDeleteBy(Long deleteBy) {
		 ...
		 * @return 当前对象
		*/
		public Department setDeleteTime(Date deleteTime) {
