 ...
 * @sign 3BC8B5F014B90B334073F822F9FF2E2A
...
public class OrderVOMeta extends OrderMeta {
	...
	*/
	 ...
	 * 代理类
	*/
	public static class $$proxy$$ extends com.scientific.tailoring.domain.order.OrderVO {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public OrderVO setIds(List<Long> ids) {
