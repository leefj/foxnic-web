 ...
 * @sign 22CEAEF2F8E6EA1EEF7A8D580FC494B7
...
public class ProcessDefinitionDeployVO extends ProcessDefinitionDeploy {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ProcessDefinitionDeployVO , 转换好的 ProcessDefinitionDeployVO 对象
	*/
	@Transient
	 ...
	 * @return ProcessDefinitionDeployVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public ProcessDefinitionDeployVO clone() {
	...
	*/
	@Transient
	public ProcessDefinitionDeployVO duplicate(boolean all) {
		org.github.foxnic.web.domain.bpm.meta.ProcessDefinitionDeployVOMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.bpm.meta.ProcessDefinitionDeployVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public ProcessDefinitionDeployVO clone(boolean deep) {
		return EntityContext.clone(ProcessDefinitionDeployVO.class,this,deep);
	}

	/**
	 * 将 Pojo 转换成 ProcessDefinitionDeployVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ProcessDefinitionDeployVO , 转换好的的 ProcessDefinitionDeploy 对象
	*/
	@Transient
	public static ProcessDefinitionDeployVO createFrom(Object pojo) {
		if(pojo==null) return null;
		ProcessDefinitionDeployVO po = EntityContext.create(ProcessDefinitionDeployVO.class,pojo);
		return po;
	}

	/**
	 * 创建一个 ProcessDefinitionDeployVO，等同于 new
	 * @return ProcessDefinitionDeployVO 对象
	*/
	@Transient
	public static ProcessDefinitionDeployVO create() {
		return EntityContext.create(ProcessDefinitionDeployVO.class);
	}
}