...
public class RoleVOMeta extends RoleMeta {
	...
	*/
	 ...
	 * 授权的账户清单 , 集合类型: LIST , 类型: org.github.foxnic.web.domain.oauth.User
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.oauth.RoleVO,org.github.foxnic.web.domain.oauth.User> USERS_PROP = new BeanProperty(org.github.foxnic.web.domain.oauth.RoleVO.class ,USERS, java.util.List.class, "授权的账户清单", "授权的账户清单", org.github.foxnic.web.domain.oauth.User.class, null);
