...
public class ExampleOrder extends Entity {
	...
	*/
	@Transient
	public ExampleOrder setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	...
	public ExampleOrder duplicate(boolean all) {
		org.github.foxnic.web.domain.dataperm.meta.ExampleOrderMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.dataperm.meta.ExampleOrderMeta.$$proxy$$();
	...
	*/
	@Transient
	public ExampleOrder clone(boolean deep) {
		return EntityContext.clone(ExampleOrder.class,this,deep);
	}
