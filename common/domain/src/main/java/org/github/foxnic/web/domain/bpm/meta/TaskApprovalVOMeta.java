...
public class TaskApprovalVOMeta extends TaskApprovalMeta {
	...
	*/
	 ...
	 * 审批人 , 类型: org.github.foxnic.web.domain.bpm.Assignee
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.TaskApprovalVO, Assignee> APPROVER_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.TaskApprovalVO.class ,APPROVER, Assignee.class, "审批人", "审批人", Assignee.class, null);

	/**
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ PAGE_INDEX , PAGE_SIZE , SEARCH_FIELD , FUZZY_FIELD , SEARCH_VALUE , DIRTY_FIELDS , SORT_FIELD , SORT_TYPE , IDS , ID , TASK_ID , PROCESS_INSTANCE_ID , APPROVAL_USER_ID , APPROVAL_TIME , APPROVAL_RESULT , APPROVAL_COMMENT , VARIABLES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , APPROVER };
	...
	public static class $$proxy$$ extends org.github.foxnic.web.domain.bpm.TaskApprovalVO {
		...
		*/
		public TaskApproval setApprover(Assignee assignee) {
			super.change(APPROVER,super.getApprover(), assignee);
			super.setApprover(assignee);
			return this;
		}
	}
}
