...
public class JobWorkerVOMeta extends JobWorkerMeta {
	...
	*/
	 ...
	 * 执行任务的Bean , 类型: org.github.foxnic.web.domain.job.JobExecuter
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.job.JobWorkerVO, JobExecutor> EXECUTOR_PROP = new BeanProperty(org.github.foxnic.web.domain.job.JobWorkerVO.class ,EXECUTOR, JobExecutor.class, "执行任务的Bean", "执行任务的Bean", JobExecutor.class, null);
