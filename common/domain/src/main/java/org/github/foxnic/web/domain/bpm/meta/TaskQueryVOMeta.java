...
public class TaskQueryVOMeta {
	...
	*/
	 ...
	 * 流程实例ID , 类型: java.lang.String
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.TaskQueryVO,java.lang.String> INSTANCE_ID_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.TaskQueryVO.class ,INSTANCE_ID, java.lang.String.class, "流程实例ID", "流程实例ID", java.lang.String.class, null);
	...
	*/
	 ...
	 * 审批人账户ID , 审批人账户 , 类型: java.lang.String
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.TaskQueryVO,java.lang.String> ASSIGNEE_USER_ID_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.TaskQueryVO.class ,ASSIGNEE_USER_ID, java.lang.String.class, "审批人账户ID", "审批人账户", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ INSTANCE_ID , ASSIGNEE_USER_ID , PAGE_SIZE , PAGE_INDEX };
}