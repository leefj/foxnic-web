...
public class NewsMeta {
	...
	*/
	 ...
	 * 内容 , 类型: java.lang.String
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.example.News,java.lang.String> CONTENT_PROP = new BeanProperty(org.github.foxnic.web.domain.example.News.class ,CONTENT, java.lang.String.class, "内容", "内容", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , TITLE , CONTENT , AUTHOR , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION };
