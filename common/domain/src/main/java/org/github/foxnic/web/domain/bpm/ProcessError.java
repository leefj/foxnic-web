...
public class ProcessError extends Entity {
	...
	*/
	...
	public ProcessError duplicate(boolean all) {
		org.github.foxnic.web.domain.bpm.meta.ProcessErrorMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.bpm.meta.ProcessErrorMeta.$$proxy$$();
	...
	*/
	@Transient
	public ProcessError clone(boolean deep) {
		return EntityContext.clone(ProcessError.class,this,deep);
	}
