...
public class TaskApprovalMeta {
	...
	*/
	 ...
	 * 审批人 , 类型: org.github.foxnic.web.domain.bpm.Assignee
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.TaskApproval, Assignee> APPROVER_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.TaskApproval.class ,APPROVER, Assignee.class, "审批人", "审批人", Assignee.class, null);

	/**
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , TASK_ID , PROCESS_INSTANCE_ID , APPROVAL_USER_ID , APPROVAL_TIME , APPROVAL_RESULT , APPROVAL_COMMENT , VARIABLES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , APPROVER };
