...
public class ApiSourceVO extends ApiSource {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ApiSourceVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ApiSourceVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ApiSourceVO , 转换好的 ApiSourceVO 对象
	*/
	@Transient
	 ...
	 * @return ApiSourceVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public ApiSourceVO clone(boolean deep) {
		return EntityContext.clone(ApiSourceVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 ApiSourceVO
	 * @param apiSourceMap 包含实体信息的 Map 对象
	 * @return ApiSourceVO , 转换好的的 ApiSource 对象
	*/
	@Transient
	public static ApiSourceVO createFrom(Map<String,Object> apiSourceMap) {
		if(apiSourceMap==null) return null;
		ApiSourceVO vo = create();
		EntityContext.copyProperties(vo,apiSourceMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 ApiSourceVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ApiSourceVO , 转换好的的 ApiSource 对象
	*/
	@Transient
	public static ApiSourceVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 ApiSourceVO，等同于 new
	 * @return ApiSourceVO 对象
	*/
	@Transient
