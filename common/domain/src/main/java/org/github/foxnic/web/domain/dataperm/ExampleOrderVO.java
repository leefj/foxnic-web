...
public class ExampleOrderVO extends ExampleOrder {
	...
	*/
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ExampleOrderVO , 转换好的 ExampleOrderVO 对象
	*/
	@Transient
	 ...
	 * @return ExampleOrderVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public ExampleOrderVO duplicate(boolean all) {
		org.github.foxnic.web.domain.dataperm.meta.ExampleOrderVOMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.dataperm.meta.ExampleOrderVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public ExampleOrderVO clone(boolean deep) {
		return EntityContext.clone(ExampleOrderVO.class,this,deep);
	}

	/**
	 * 将 Pojo 转换成 ExampleOrderVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ExampleOrderVO , 转换好的的 ExampleOrder 对象
	*/
	@Transient
	public static ExampleOrderVO createFrom(Object pojo) {
		if(pojo==null) return null;
		ExampleOrderVO po = EntityContext.create(ExampleOrderVO.class,pojo);
		return po;
	}

	/**
	 * 创建一个 ExampleOrderVO，等同于 new
	 * @return ExampleOrderVO 对象
	*/
	@Transient
	public static ExampleOrderVO create() {
		return EntityContext.create(ExampleOrderVO.class);
	}
}