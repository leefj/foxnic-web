...
public class ProcessInitiatorVO extends ProcessInitiator {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ProcessInitiatorVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ProcessInitiatorVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ProcessInitiatorVO , 转换好的 ProcessInitiatorVO 对象
	*/
	@Transient
	 ...
	 * @return ProcessInitiatorVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public ProcessInitiatorVO duplicate(boolean all) {
		org.github.foxnic.web.domain.bpm.meta.ProcessInitiatorVOMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.bpm.meta.ProcessInitiatorVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public ProcessInitiatorVO clone(boolean deep) {
		return EntityContext.clone(ProcessInitiatorVO.class,this,deep);
	}
	...
	*/
	...
	/**
	 * 创建一个 ProcessInitiatorVO，等同于 new
	 * @return ProcessInitiatorVO 对象
	*/
	@Transient
