	...
	public static class PCM_CATALOG_ATTRIBUTE extends DBTable {
		...
		*/
		...
		public PCM_CATALOG_ATTRIBUTE() {
			this.init($NAME,"数据存储分配表" , ID , STORAGE_ID , FIELD , DATA_TYPE , SHORT_NAME , FULL_NAME , HINT , DETAIL , NOTE , VALID , LENGTH , PRECISION , SCALE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
