...
public class FoxnicWeb {
	...
	*/
	public static class EAM_ASSET extends DBTable {
		...
		*/
		 ...
		 * 资产编号
		*/
		public static final DBField UUID = new DBField(DBDataType.STRING , "uuid","uuid","资产编号","资产编号",false,false,false);
		
		/**
		 * 资产状态
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","资产状态","资产状态",false,false,false);
		
		/**
		 * 资产RFID
		*/
		public static final DBField RFID = new DBField(DBDataType.STRING , "rfid","rfid","资产RFID","资产RFID",false,false,false);
	 ...
	 * 资产库存表
	*/
	public static class EAM_ASSET_STOCK extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_stock";
		...
		*/
		 ...
		 * 物品ID
		*/
		public static final DBField GOODS_ID = new DBField(DBDataType.STRING , "goods_id","goodsId","物品ID","物品ID",false,false,false);
		...
		*/
		 ...
		 * 总数
		*/
		public static final DBField COUNT = new DBField(DBDataType.DECIMAL , "count","count","总数","总数",false,false,false);
		...
		*/
		...
		public EAM_ASSET_STOCK() {
			this.init($NAME,"资产库存表" , ID , GOODS_ID , BATCH_NUMBER , SUPPLIER_ID , COUNT , SOURCE_ID , SOURCE_DETAIL , MANAGEORG_ID , PRODUCTION_DATE , PURCHASE_DATE , PURCHASE_UNIT_PRICE , MANAGER_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_STOCK $TABLE=new EAM_ASSET_STOCK();
	}
	...
	*/
	public static class EAM_GOODS extends DBTable {
		...
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","状态","valid有效，invalid无效",false,false,false);
		
		/**
		 * 分类ID
		*/
		public static final DBField CATEGORY_ID = new DBField(DBDataType.STRING , "category_id","categoryId","分类ID","分类ID",false,false,false);
		...
		*/
		 ...
		 * 厂商
		*/
		public static final DBField MANUFACTURER_ID = new DBField(DBDataType.STRING , "manufacturer_id","manufacturerId","厂商","厂商",false,false,false);
		
		/**
		 * 品牌
		*/
		public static final DBField BRAND_ID = new DBField(DBDataType.STRING , "brand_id","brandId","品牌","品牌",false,false,false);
		
		/**
		 * 规格型号
		*/
		public static final DBField MODEL = new DBField(DBDataType.STRING , "model","model","规格型号","规格型号",false,false,false);
		...
		*/
		...
		public EAM_GOODS() {
			this.init($NAME,"资产物品表" , ID , STATUS , CATEGORY_ID , CODE , NAME , MANUFACTURER_ID , BRAND_ID , MODEL , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
