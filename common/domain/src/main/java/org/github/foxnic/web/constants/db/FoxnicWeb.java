	...
	*/
	public static class SYS_CODE_EXAMPLE extends DBTable {
		...
		*/
		 ...
		 * 选择框(查询)
		*/
		public static final DBField SELECT_API = new DBField(DBDataType.STRING , "select_api","selectApi","选择框(查询)","选择框(查询)",false,false,true);
		...
		*/
		...
		public SYS_CODE_EXAMPLE() {
			this.init($NAME,"代码生成示例" , ID , NAME , NOTES , IMAGE_ID , FILE_IDS , AREA , WEIGHT , VALID , RADIO_ENUM , RADIO_DICT , CHECK_ENUM , CHECK_DICT , SELECT_ENUM , SELECT_DICT , SELECT_API , BIRTHDAY , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class SYS_ROLE_MENU extends DBTable {
		...
		*/
		 ...
		 * 角色ID
		*/
		public static final DBField ROLE_ID = new DBField(DBDataType.STRING , "role_id","roleId","角色ID","角色ID",false,false,false);
		
		/**
		 * 菜单ID
		*/
		public static final DBField MENU_ID = new DBField(DBDataType.STRING , "menu_id","menuId","菜单ID","菜单ID",false,false,false);
	...
	*/
	public static class SYS_USER extends DBTable {
		...
		*/
		...
		public SYS_USER() {
			this.init($NAME,"账户表" , ID , NAME , PASSWD , PHONE , PORTRAIT_ID , PERSON_ID , LANGUAGE , EMPLOYEE_ID , VALID , LAST_LOGIN_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
