 ...
 * @since 2021-06-28 13:39:42
 * @sign DE985B6C5C5C64849B6CEDB4C4D342AC
...
public class ResourzeMeta {
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ ID , TYPE , URL , METHOD , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION };
