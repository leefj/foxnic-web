...
public class ChangeDefinition extends Entity {
	...
	*/
	@Transient
	public ChangeDefinition setDeleted(Boolean deletedBool) {
		if(deletedBool==null) {
			this.deleted=null;
		} else {
	...
	*/
	@Transient
	public ChangeDefinition clone() {
		return EntityContext.clone(ChangeDefinition.class,this);
	}
	...
	*/
	@Transient
	public ChangeDefinition clone(boolean deep) {
		return EntityContext.clone(ChangeDefinition.class,this,deep);
	}
