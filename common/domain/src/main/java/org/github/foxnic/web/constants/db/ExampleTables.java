	...
	public static class EXAMPLE_ADDRESS extends DBTable {
		...
		*/
		...
		public EXAMPLE_ADDRESS() {
			this.init($NAME,"" , ID , NAME , PHONE_NUMBER , ADDRESS , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
