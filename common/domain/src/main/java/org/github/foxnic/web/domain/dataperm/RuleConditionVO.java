...
public class RuleConditionVO extends RuleCondition {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public RuleConditionVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public RuleConditionVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return RuleConditionVO , 转换好的 RuleConditionVO 对象
	*/
	@Transient
	 ...
	 * @return RuleConditionVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public RuleConditionVO duplicate(boolean all) {
		org.github.foxnic.web.domain.dataperm.meta.RuleConditionVOMeta.$$proxy$$ inst = new org.github.foxnic.web.domain.dataperm.meta.RuleConditionVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public RuleConditionVO clone(boolean deep) {
		return EntityContext.clone(RuleConditionVO.class,this,deep);
	}

	/**
	 * 将 Pojo 转换成 RuleConditionVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return RuleConditionVO , 转换好的的 RuleCondition 对象
	*/
	@Transient
	public static RuleConditionVO createFrom(Object pojo) {
		if(pojo==null) return null;
		RuleConditionVO po = EntityContext.create(RuleConditionVO.class,pojo);
		return po;
	}

	/**
	 * 创建一个 RuleConditionVO，等同于 new
	 * @return RuleConditionVO 对象
	*/
	@Transient
	public static RuleConditionVO create() {
		return EntityContext.create(RuleConditionVO.class);
	}
}