...
public class JobWorkerMeta {
	...
	*/
	 ...
	 * 执行任务的Bean , 类型: org.github.foxnic.web.domain.job.JobExecuter
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.job.JobWorker, JobExecutor> EXECUTOR_PROP = new BeanProperty(org.github.foxnic.web.domain.job.JobWorker.class ,EXECUTOR, JobExecutor.class, "执行任务的Bean", "执行任务的Bean", JobExecutor.class, null);
