...
public class ProcessJumpVOMeta {
	...
	*/
	 ...
	 * 目标节点ID , 类型: java.lang.String
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.ProcessJumpVO,java.lang.String> TARGET_NODE_ID_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.ProcessJumpVO.class ,TARGET_NODE_ID, java.lang.String.class, "目标节点ID", "目标节点ID", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ PROCESS_INSTANCE_ID , TARGET_NODE_ID , REASON , VARIABLES };
}