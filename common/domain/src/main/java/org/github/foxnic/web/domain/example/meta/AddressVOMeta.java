 ...
 * @sign 0B7237DD7D7F6DE49CF3F7F8BED325FE
...
public class AddressVOMeta extends AddressMeta {
	...
	*/
	 ...
	 * version , 类型: java.lang.Integer
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.example.AddressVO,java.lang.Integer> VERSION_PROP = new BeanProperty(org.github.foxnic.web.domain.example.AddressVO.class ,VERSION, java.lang.Integer.class, "version", "version", java.lang.Integer.class, null);
	...
	*/
	 ...
	 * 订单 , 集合类型: LIST , 类型: org.github.foxnic.web.domain.example.Order
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.example.AddressVO,org.github.foxnic.web.domain.example.Order> ORDER_LIST_PROP = new BeanProperty(org.github.foxnic.web.domain.example.AddressVO.class ,ORDER_LIST, java.util.List.class, "订单", "订单", org.github.foxnic.web.domain.example.Order.class, null);
	
	/**
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ PAGE_INDEX , PAGE_SIZE , SEARCH_FIELD , FUZZY_FIELD , SEARCH_VALUE , DIRTY_FIELDS , SORT_FIELD , SORT_TYPE , IDS , ID , NAME , PHONE_NUMBER , ADDRESS , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , GOODS_LIST , ITEM_LIST , ORDER_LIST };
