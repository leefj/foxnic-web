...
public class TaskAssigneeVOMeta extends TaskAssigneeMeta {
	...
	*/
	 ...
	 * 审批人 , 类型: org.github.foxnic.web.domain.bpm.Assignee
	*/
	public static final BeanProperty<org.github.foxnic.web.domain.bpm.TaskAssigneeVO, Assignee> ASSIGNEE_PROP = new BeanProperty(org.github.foxnic.web.domain.bpm.TaskAssigneeVO.class ,ASSIGNEE, Assignee.class, "审批人", "审批人", Assignee.class, null);
