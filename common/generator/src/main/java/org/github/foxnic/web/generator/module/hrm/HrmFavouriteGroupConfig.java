...
public class HrmFavouriteGroupConfig extends BaseCodeConfig<HRM_FAVOURITE_GROUP> {

    public HrmFavouriteGroupConfig() {
        super(PREFIX_HRM, HRM_FAVOURITE_GROUP.$TABLE,"hrm_", 4);
    }
