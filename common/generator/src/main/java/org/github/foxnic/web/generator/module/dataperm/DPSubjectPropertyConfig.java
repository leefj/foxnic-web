...
public class DPSubjectPropertyConfig extends BaseCodeConfig<DP_SUBJECT_PROPERTY> {

	public DPSubjectPropertyConfig() {
		super(PREFIX_DATA_PERM,DP_SUBJECT_PROPERTY.$TABLE,"dp_", 3);
	}
