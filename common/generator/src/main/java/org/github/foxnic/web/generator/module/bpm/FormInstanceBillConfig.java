...
public class FormInstanceBillConfig extends BaseCodeConfig<BPM_FORM_INSTANCE_BILL> {

    public FormInstanceBillConfig() {
        super(PREFIX_BPM, BPM_FORM_INSTANCE_BILL.$TABLE,"bpm_", 4);
    }
