...
public class RoleMenuController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = RoleMenuVOMeta.ID , value = "id" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleMenuVOMeta.ROLE_ID , value = "角色ID" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleMenuVOMeta.MENU_ID , value = "菜单ID" , required = false , dataTypeClass=String.class),
	})
