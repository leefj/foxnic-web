...
public class OauthClientController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = OauthClientVOMeta.ID , value = "客户端标识" , required = true , dataTypeClass=String.class , example = "333333"),
		...
		@ApiImplicitParam(name = OauthClientVOMeta.CLIENT_SECRET , value = "访问密匙" , required = false , dataTypeClass=String.class , example = "$2a$10$/kGGWTTavnaKYu3gbi7C3ef8SFk9e1f0AVmbVeHx9NGTTyP/lbv8q"),
		@ApiImplicitParam(name = OauthClientVOMeta.SCOPE , value = "权限范围" , required = false , dataTypeClass=String.class , example = "read"),
		@ApiImplicitParam(name = OauthClientVOMeta.AUTHORIZED_GRANT_TYPES , value = "授权类型" , required = false , dataTypeClass=String.class , example = "authorization_code,refresh_token"),
		@ApiImplicitParam(name = OauthClientVOMeta.WEB_SERVER_REDIRECT_URI , value = "重定向URI" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = OauthClientVOMeta.AUTHORITIES , value = "权限值列表" , required = false , dataTypeClass=String.class , example = "ROLE_USER,ROLE_MOBILE"),
		...
		@ApiImplicitParam(name = OauthClientVOMeta.VALID , value = "是否有效" , required = false , dataTypeClass=Integer.class , example = "true"),
