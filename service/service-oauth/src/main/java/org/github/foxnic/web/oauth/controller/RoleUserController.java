...
public class RoleUserController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = RoleUserVOMeta.ID , value = "id" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleUserVOMeta.ROLE_ID , value = "角色ID" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleUserVOMeta.USER_ID , value = "账户ID" , required = false , dataTypeClass=String.class),
	})
