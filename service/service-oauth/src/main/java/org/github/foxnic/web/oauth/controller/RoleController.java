...
public class RoleController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = RoleVOMeta.ID , value = "ID" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleVOMeta.CODE , value = "代码" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = RoleVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class),
	})
