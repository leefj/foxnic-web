...
public interface IOrderItemService extends ISuperService<OrderItem> {
	 ...
	 * @return 查询结果
	 * */
	List<OrderItem> queryList(OrderItem sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<OrderItem> queryPagedList(OrderItem sample,int pageSize,int pageIndex);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(OrderItem sample);
