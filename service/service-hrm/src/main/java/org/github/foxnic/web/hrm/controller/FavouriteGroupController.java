...
public class FavouriteGroupController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = FavouriteGroupVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.NAME, value = "组名", required = true, dataTypeClass = String.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.PARENT_ID, value = "上级ID", required = true, dataTypeClass = String.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.EMPLOYEE_ID, value = "所有者ID", required = true, dataTypeClass = String.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.HIERARCHY, value = "层级路径", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.SORT, value = "排序", required = false, dataTypeClass = Integer.class), @ApiImplicitParam(name = FavouriteGroupVOMeta.COMPANY_ID, value = "总公司ID", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = FavouriteGroupVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = FavouriteGroupVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = FavouriteGroupVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
