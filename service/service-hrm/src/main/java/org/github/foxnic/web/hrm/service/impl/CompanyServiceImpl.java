...
public class CompanyServiceImpl extends SuperService<Company> implements ICompanyService {
	 ...
	 */
	@Override
	public Result insert(Company company,boolean throwsException) {
		Result r=super.insert(company,throwsException);
		return r;
	}
	...
	public Result insert(Company company) {
		return this.insert(company,true);
	}
	...
	public Result update(Company company , SaveMode mode) {
		return this.update(company,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(Company company , SaveMode mode,boolean throwsException) {
		Result r=super.update(company , mode , throwsException);
		return r;
	}
