...
public interface IEmployeeService extends ISuperService<Employee> {
	 ...
	 * @return 判断结果
	 */
	Result<Employee> checkExists(Employee employee);
	 ...
	 * 	@return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(Employee sample,String tableAliase);
	 ...
	 * 导出 Excel
	 * */
	ExcelWriter exportExcel(Employee sample);
