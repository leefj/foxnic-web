...
public class RoleServiceImpl extends SuperService<Role> implements IRoleService {
	...
	public Result update(Role role , SaveMode mode) {
		Result r=super.update(role , mode);
		return r;
	}
	...
	@Override
	public List<Role> getByCodes(List<String> codes) {
	...
	public List<Role> getEmployeeRoles(String employeeId) {
		...
		List<String> list=new ArrayList<>(roleIds);
		return this.getByIds(list);
	}
