...
public class SubjectPropertyServiceImpl extends SuperService<SubjectProperty> implements ISubjectPropertyService {
	 ...
	 */
	@Override
	public Result insert(SubjectProperty subjectProperty,boolean throwsException) {
		Result r=super.insert(subjectProperty,throwsException);
		return r;
	}
	...
	public Result insert(SubjectProperty subjectProperty) {
		return this.insert(subjectProperty,true);
	}
	...
	public Result update(SubjectProperty subjectProperty , SaveMode mode) {
		return this.update(subjectProperty,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(SubjectProperty subjectProperty , SaveMode mode,boolean throwsException) {
		Result r=super.update(subjectProperty , mode , throwsException);
		return r;
	}
