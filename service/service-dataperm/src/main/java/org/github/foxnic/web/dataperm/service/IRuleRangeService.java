...
public interface IRuleRangeService extends ISuperService<RuleRange> {
	 ...
	 */
	Result insert(RuleRange ruleRange,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(RuleRange ruleRange , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(RuleRange ruleRange , SaveMode mode,boolean throwsException);
