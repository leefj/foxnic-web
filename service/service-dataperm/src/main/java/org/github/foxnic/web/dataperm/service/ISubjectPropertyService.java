...
public interface ISubjectPropertyService extends ISuperService<SubjectProperty> {
	 ...
	 */
	Result insert(SubjectProperty subjectProperty,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(SubjectProperty subjectProperty , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(SubjectProperty subjectProperty , SaveMode mode,boolean throwsException);
