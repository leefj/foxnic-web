...
public class BusiRoleMemberController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleMemberVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "27684550612090880"), @ApiImplicitParam(name = BusiRoleMemberVOMeta.ROLE_ID, value = "角色ID", required = false, dataTypeClass = String.class, example = "524224688444936192"), @ApiImplicitParam(name = BusiRoleMemberVOMeta.MEMBER_ID, value = "成员ID", required = false, dataTypeClass = String.class, example = "544487545157713920"), @ApiImplicitParam(name = BusiRoleMemberVOMeta.MEMBER_TYPE, value = "成员类型", required = false, dataTypeClass = String.class, example = "employee") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleMemberVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "27684550612090880") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleMemberVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleMemberVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
    ...
    public Result<BusiRoleMember> getById(String id) {
        ...
        // join 关联的对象
        busiRoleMemberService.dao().fill(busiRoleMember).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.PERSON).with(BusiRoleMemberMeta.EMPLOYEE).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.POSITIONS).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.ORGANIZATIONS).execute();
    ...
    public Result<PagedList<BusiRoleMember>> queryPagedList(BusiRoleMemberVO sample) {
        ...
        // join 关联的对象
        busiRoleMemberService.dao().fill(list).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.PERSON).with(BusiRoleMemberMeta.EMPLOYEE).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.POSITIONS).with(BusiRoleMemberMeta.EMPLOYEE, EmployeeMeta.ORGANIZATIONS).execute();
        result.success(true).data(list);
        return result;
    }
}
