...
public interface ICodeExampleCarService extends ISuperService<CodeExampleCar> {
	 ...
	 */
	Result insert(CodeExampleCar codeExampleCar,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(CodeExampleCar codeExampleCar , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(CodeExampleCar codeExampleCar , SaveMode mode,boolean throwsException);
	 ...
	 * @return 判断结果
	 */
	Boolean checkExists(CodeExampleCar codeExampleCar);
