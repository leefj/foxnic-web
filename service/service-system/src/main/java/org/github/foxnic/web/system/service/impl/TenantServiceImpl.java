...
public class TenantServiceImpl extends SuperService<Tenant> implements ITenantService {
	...
	@Override
	public List<Tenant> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, Tenant> queryMapByIds(List<String> ids) {
	 ...
	 * */
	@Override
	public List<Tenant> queryList(TenantVO sample) {
	 ...
	 * */
	@Override
	public PagedList<Tenant> queryPagedList(TenantVO sample, int pageSize, int pageIndex) {
