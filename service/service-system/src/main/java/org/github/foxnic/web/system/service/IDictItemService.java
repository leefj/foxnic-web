...
public interface IDictItemService extends ISuperService<DictItem> {
	 ...
	 * */
	ConditionExpr buildQueryCondition(DictItem sample,boolean stringFuzzy);
	 ...
	 * @return ConditionExpr 条件表达式
	 * */
	ConditionExpr buildQueryCondition(DictItem sample,boolean stringFuzzy,String tableAliase);
