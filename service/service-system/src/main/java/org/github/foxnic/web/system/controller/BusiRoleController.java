...
public class BusiRoleController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "498946989573017600"), @ApiImplicitParam(name = BusiRoleVOMeta.ORG_ID, value = "所属组织ID", required = false, dataTypeClass = Integer.class), @ApiImplicitParam(name = BusiRoleVOMeta.CODE, value = "角色代码", required = false, dataTypeClass = String.class, example = "drafter"), @ApiImplicitParam(name = BusiRoleVOMeta.NAME, value = "角色名称", required = false, dataTypeClass = String.class, example = "起草人"), @ApiImplicitParam(name = BusiRoleVOMeta.VALID, value = "是否有效", required = true, dataTypeClass = Integer.class, example = "1") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "498946989573017600") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = BusiRoleVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "employeeId", value = "员工ID", required = true, dataTypeClass = String.class, example = "1") })
    @ApiOperationSupport(order = 6)
     ...
     */
    @ApiOperation(value = "获取业务角色")
    @ApiImplicitParams({ @ApiImplicitParam(name = "codes", value = "代码", required = true, dataTypeClass = String.class, example = "001") })
    @ApiOperationSupport(order = 6)
