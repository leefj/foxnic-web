...
public class CodeExampleStudentController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleStudentVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "476464971060871168") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleStudentVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleStudentVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
