...
public class UserTenantController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = UserTenantVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class , example = "482911452353536000"),
		@ApiImplicitParam(name = UserTenantVOMeta.USER_ID , value = "用户ID" , required = false , dataTypeClass=String.class , example = "1"),
		@ApiImplicitParam(name = UserTenantVOMeta.OWNER_TENANT_ID , value = "所属的租户ID" , required = false , dataTypeClass=String.class , example = "482902318371573760"),
		@ApiImplicitParam(name = UserTenantVOMeta.VALID , value = "是否有效" , required = false , dataTypeClass=Integer.class , example = "1"),
		@ApiImplicitParam(name = UserTenantVOMeta.ACTIVATED , value = "是否激活" , required = false , dataTypeClass=Integer.class , example = "1"),
