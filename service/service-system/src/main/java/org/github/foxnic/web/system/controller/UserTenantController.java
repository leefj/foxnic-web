...
public class UserTenantController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = UserTenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "482928963765678080"), @ApiImplicitParam(name = UserTenantVOMeta.USER_ID, value = "用户ID", required = false, dataTypeClass = String.class, example = "480790327339261952"), @ApiImplicitParam(name = UserTenantVOMeta.OWNER_TENANT_ID, value = "所属的租户ID", required = false, dataTypeClass = String.class, example = "T002"), @ApiImplicitParam(name = UserTenantVOMeta.VALID, value = "是否有效", required = false, dataTypeClass = Integer.class, example = "1"), @ApiImplicitParam(name = UserTenantVOMeta.ACTIVATED, value = "是否激活", required = false, dataTypeClass = Integer.class, example = "0"), @ApiImplicitParam(name = UserTenantVOMeta.EMPLOYEE_ID, value = "员工ID", required = false, dataTypeClass = String.class, example = "E001"), @ApiImplicitParam(name = UserTenantVOMeta.SORT, value = "顺序", required = false, dataTypeClass = Integer.class, example = "1") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = UserTenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "482928963765678080") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = UserTenantVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = UserTenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
