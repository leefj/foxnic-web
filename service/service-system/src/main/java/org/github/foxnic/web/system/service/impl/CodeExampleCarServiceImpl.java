...
public class CodeExampleCarServiceImpl extends SuperService<CodeExampleCar> implements ICodeExampleCarService {
	 ...
	 */
	@Override
	public Result insert(CodeExampleCar codeExampleCar,boolean throwsException) {
		Result r=super.insert(codeExampleCar,throwsException);
		return r;
	}
	...
	public Result insert(CodeExampleCar codeExampleCar) {
		return this.insert(codeExampleCar,true);
	}
	...
	public Result update(CodeExampleCar codeExampleCar , SaveMode mode) {
		return this.update(codeExampleCar,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(CodeExampleCar codeExampleCar , SaveMode mode,boolean throwsException) {
		Result r=super.update(codeExampleCar , mode , throwsException);
		return r;
	}
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(CodeExampleCar codeExampleCar) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(codeExampleCar, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
