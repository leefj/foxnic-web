...
public class TenantController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = TenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "489310412978790400"), @ApiImplicitParam(name = TenantVOMeta.ALIAS, value = "别名", required = false, dataTypeClass = String.class, example = "1212"), @ApiImplicitParam(name = TenantVOMeta.VALID, value = "是否有效", required = false, dataTypeClass = Integer.class, example = "1"), @ApiImplicitParam(name = TenantVOMeta.COMPANY_ID, value = "公司ID", required = false, dataTypeClass = String.class, example = "001") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = TenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "489310412978790400") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = TenantVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = TenantVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
    ...
    public Result<Tenant> getById(String id) {
        ...
        // join 关联的对象
        tenantService.dao().fill(tenant).with(TenantMeta.COMPANY).with(TenantMeta.COMPANY).execute();
    ...
    public Result<PagedList<Tenant>> queryPagedList(TenantVO sample) {
        ...
        // join 关联的对象
        tenantService.dao().fill(list).with(TenantMeta.COMPANY).with(TenantMeta.COMPANY).execute();
        result.success(true).data(list);
        return result;
    }
}
