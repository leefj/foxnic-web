...
public interface ICodeExampleService extends  ISimpleIdService<CodeExample,String> {
	 ...
	 */
	Result insert(CodeExample codeExample,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(CodeExample codeExample , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(CodeExample codeExample , SaveMode mode,boolean throwsException);
	 ...
	 * @return 实体集
	 * */
	List<CodeExample> queryListByIds(List<String> ids);

	/**
	 * 按 id 列表查询 Map
	 * @param ids  主键清单
	 * */
	Map<String, CodeExample> queryMapByIds(List<String> ids);
	 ...
	 * @return 判断结果
	 */
	Boolean checkExists(CodeExample codeExample);
	 ...
	 * @return 查询结果
	 * */
	List<CodeExample> queryList(CodeExampleVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<CodeExample> queryPagedList(CodeExampleVO sample,int pageSize,int pageIndex);
