...
public class CodeExampleCarController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleCarVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "476464971060871168"), @ApiImplicitParam(name = CodeExampleCarVOMeta.EXAMPLE_ID, value = "属主ID", required = false, dataTypeClass = String.class, example = "476069797533057024"), @ApiImplicitParam(name = CodeExampleCarVOMeta.PLATE_NUMBER, value = "车牌号", required = false, dataTypeClass = String.class, example = "110352963290923110"), @ApiImplicitParam(name = CodeExampleCarVOMeta.COLOR, value = "颜色", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.POSITION_ID, value = "岗位单选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.ORG_ID, value = "组织单选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.EMP_ID, value = "员工单选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.POSITION_IDS, value = "岗位多选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.ORG_IDS, value = "组织多选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.EMP_IDS, value = "员工多选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.SELECT_EMP_ID, value = "员工下拉", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.COM_ID, value = "公司单选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.DEPT_IDS, value = "部门多选", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeExampleCarVOMeta.SUB_ORG_ID, value = "限定上级", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleCarVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeExampleCarVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
    ...
    public Result<CodeExampleCar> getById(String id) {
        ...
        // join 关联的对象
        codeExampleCarService.dao().fill(codeExampleCar).with(CodeExampleCarMeta.ORGANIZATION).with(CodeExampleCarMeta.SUB_ORGANIZATION).with(CodeExampleCarMeta.COMPANY).with(CodeExampleCarMeta.POSITION).with(CodeExampleCarMeta.EMPLOYEE, EmployeeMeta.PERSON).execute();
    ...
    public Result<PagedList<CodeExampleCar>> queryPagedList(CodeExampleCarVO sample) {
        ...
        // join 关联的对象
        codeExampleCarService.dao().fill(list).with(CodeExampleCarMeta.ORGANIZATION).with(CodeExampleCarMeta.SUB_ORGANIZATION).with(CodeExampleCarMeta.COMPANY).with(CodeExampleCarMeta.POSITION).with(CodeExampleCarMeta.EMPLOYEE, EmployeeMeta.PERSON).execute();
        result.success(true).data(list);
        return result;
    }
