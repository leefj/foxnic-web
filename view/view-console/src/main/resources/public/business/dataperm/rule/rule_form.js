...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('dp-rule-form-data-form-action');
		//如果没有修改和保存权限
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('dp-rule-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('dp-rule-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('dp-rule-form-data-popup-index');
				var doNext=true;
