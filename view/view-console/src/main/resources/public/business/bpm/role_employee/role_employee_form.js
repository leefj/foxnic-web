...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('bpm-role-employee-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('bpm-role-employee-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('bpm-role-employee-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('bpm-role-employee-form-data-popup-index');
