...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('hrm-employee-position-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('hrm-employee-position-form-area', area);
	...
	function fillFormData() {
		var formData = admin.getTempData('hrm-employee-position-form-data');
	...
	function saveForm(data) {
		...
		admin.request(api, data, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('hrm-employee-position-form-data-popup-index');
