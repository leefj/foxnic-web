...
function ListPage() {
	...
	function bindButtonEvent() {
        ...
        function batchDelete(selected) {
            ...
            if(ids.length==0) {
            	layer.msg(fox.translate('请选择需要删除的')+fox.translate('代码生成拥有的车辆')+"!");
            	return;
            }
            //调用批量删除接口
	...
	function showEditForm(data) {
		...
		var title = (data && data.id) ? (fox.translate('修改')+fox.translate('代码生成拥有的车辆')) : (fox.translate('添加')+fox.translate('代码生成拥有的车辆'));
		...
		admin.putTempData('sys-code-example-car-form-data-popup-index', index);
	};
