...
function FormPage() {
	...
	this.init=function(layui) {
		...
		notExistAction=admin.getTempData('sys-profile-form-data-form-notExistAction');
		//如果没有修改和保存权限
		...
		if(window.pageExt.form.beforeInit) {
			window.pageExt.form.beforeInit(notExistAction,admin.getTempData('sys-profile-form-data'));
		}
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('sys-profile-form-data');
		}
	...
	function saveForm(param,callback) {
		...
		admin.post(api, param, function (data) {
			if (data.success) {
				...
				if(doNext) {
					admin.finishPopupCenterById('sys-profile-form-data-win');
				}
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('sys-profile-form-data-win',this); });
