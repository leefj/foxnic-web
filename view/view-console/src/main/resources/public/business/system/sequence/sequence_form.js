...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('sys-sequence-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function fillFormData() {
		var formData = admin.getTempData('sys-sequence-form-data');
	...
	function saveForm(data) {
		var api=moduleURL+"/"+(data.pk?"update":"insert");
