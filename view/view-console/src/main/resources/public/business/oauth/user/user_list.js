    ...
    function renderTable() {
		...
		fox.renderTable({
			...
			cols: [[
				...
				{ field: 'portraitId', sort: true, title: fox.translate('头像ID'), templet: function (d) { return '<img style="height:100%;" fileType="image/png" onclick="window.previewImage(this)"  src="'+apiurls.storage.image+'?id='+ d.portraitId+'" />'; } } ,
