...
function ListPage() {
	...
	function bindButtonEvent() {
        ...
        function batchDelete(selected) {
            ...
            if(ids.length==0) {
            	layer.msg(fox.translate('请选择需要删除的')+fox.translate('系统资源')+"!");
            	return;
            }
            //调用批量删除接口
    ...
    function bindRowOperationEvent() {
		...
		table.on('tool(data-table)', function (obj) {
			...
			if (layEvent === 'edit') { // 修改
				...
				layer.confirm(fox.translate('确定删除此')+fox.translate('系统资源')+fox.translate('吗？'), function (i) {
					layer.close(i);
