...
function FormPage() {
	...
	this.init=function(layui) {
		...
		if(admin.getTempData('chs-change-bill-form-data-form-action')=="view") {
			disableModify=true;
		}
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('chs-change-bill-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('chs-change-bill-form-data');
		}
	...
	function saveForm(param) {
		...
		admin.request(api, param, function (data) {
			...
			if (data.success) {
				...
				var index=admin.getTempData('chs-change-bill-form-data-popup-index');
