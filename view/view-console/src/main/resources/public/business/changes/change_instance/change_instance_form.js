...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('chs-change-instance-form-data-form-action');
		//如果没有修改和保存权限
	...
	function adjustPopup() {
		...
		adjustPopupTask=setTimeout(function () {
			...
			if(area==null) return;
			admin.putTempData('chs-change-instance-form-area', area);
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('chs-change-instance-form-data');
		}
