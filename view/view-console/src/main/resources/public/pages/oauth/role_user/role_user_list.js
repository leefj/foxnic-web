...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-oauth/sys-role-user";
	...
	function showEditForm(data) {
		...
		admin.putTempData('sys-role-user-form-data', data);
		var area=admin.getTempData('sys-role-user-form-area');
		...
		admin.popupCenter({
			...
			type: 2,
			content: '/pages/oauth/role_user/role_user_form.html' + queryString,
			finish: function () {
				refreshTableData();
			}
		});
